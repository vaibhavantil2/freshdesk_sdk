...
module.exports = {
  liquefy: function(params, type) {
    ...
    var userObj = {
      "id" : helper.getStringValue(userDetails, "id"),
      "name" : helper.getStringValue(userDetails, "name"),
      "email" : helper.getStringValue(userDetails, "email"),
      "active" : helper.getStringValue(userDetails, "active").bool()
    };
