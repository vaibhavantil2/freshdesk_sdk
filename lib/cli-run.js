...
exports.run = function() {
  ...
  var plugExec = function(req, res) {
    ...
    var renderParams = JSON.parse((JSON.stringify(wow) + JSON.stringify(curusrLiqObj) + JSON.stringify(namespace)).replace(/}{/g,","));
    var consolidatedOutput = require(__dirname + '/unifier').unify(function(data) {
