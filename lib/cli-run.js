...
var iparam = require(__dirname + "/iparam-util");
var unifier = require(__dirname + '/unifier');
...
exports.run = function() {
  ...
  var plugExec = function(req, res) {
    ...
    var renderParams = JSON.parse((JSON.stringify(liquidParams) +
      JSON.stringify(curusrLiqObj) +
      JSON.stringify(namespace) +
      JSON.stringify(iparams)).replace(/}{/g,",")); // last replace() for combining all jsons to one.
